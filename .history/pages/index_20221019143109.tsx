...
`; 
  ...
  *[_type == "social"]
  `;
	...
	const skills: PageInfo = await sanityClient.fetch(skillsQuery); 
	const experiences: PageInfo = await sanityClient.fetch(experiencesQuery); 
	const projects: PageInfo = await sanityClient.fetch(projectsQuery); 
	const socials: PageInfo = await sanityClient.fetch(socialsQuery); 
