        ...
        snap-mandatory z-20 scrollbar scrollbar-track-gray-400/20 scrollbar-thin scrollbar-thumb-[#F7AB0A]/80">
          {
            projects.map((project, i) => (      
                ...
                items-center justify-center p-20 md:p-44 h-screen">
                  <Link  href={project?.linkToBuild} rel="noopener noreferrer" >
                    <motion.img
                    className="cursor-pointer hover:border filter group-hover:grayscale transition duration-300 ease-in-out"
